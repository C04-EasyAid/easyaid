                        ...
                        <div class="card shadow overflow-hidden p-2">
                            <div class="row g-0">
                                <div class="col-md-5 overflow-hidden">
                                    <img src="../image/1.<%=x%>.jpg" class="rounded-2" height="279" width="341"
                                         alt="Card image">
                                    <!-- Ribbon -->
                                ...
                                <div class="col-md-7">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <a href="#" class="badge bg-danger text-white mb-2 mb-sm-0">In
                                                corso</a><%}%>
                                            <%if (tutorato.getStatus() != 1) {%>
                                            <a href="#"
                                               class="badge bg-success text-white mb-2 mb-sm-0">Completato</a><%}%>
                                            <div>
                                        ...
                                        <div class="mb-0 ms-2">
                                            <h6><p class="card-description">
                                                <br><code>&lt;<%=tutorato.getStudenteEmail()%>&gt;</code>
                                            </p></h6>
                                        </div>
                                        ...
                                        <ul class="list-inline">
                                            <li class="list-inline-item h6 fw-light mb-1 mb-sm-0">
                                                ...
                                                <%=tutorato.getOreDisponibili().toUpperCase(java.util.Locale.ROOT)%>
                                            </li>
                                            <li class="list-inline-item h6 fw-light mb-1 mb-sm-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                ...
                                                <%=tutorato.getDipartimento().toUpperCase(java.util.Locale.ROOT)%>
                                            </li>
                                            <li class="list-inline-item h6 fw-light">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    ...
                                                    <path fill-rule="evenodd"
                                                          d="M6 8V1h1v6.117L8.743 6.07a.5.5 0 0 1 .514 0L11 7.117V1h1v7a.5.5 0 0 1-.757.429L9 7.083 6.757 8.43A.5.5 0 0 1 6 8z"></path>
                                                    <path d="M3 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-1h1v1a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v1H1V2a2 2 0 0 1 2-2z"></path>
                                                    <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1z"></path>
                                                </svg>
                                                <%=tutorato.getInsegnamento().toUpperCase(java.util.Locale.ROOT)%>
                                            </li>
                                        </ul>
                                        <div class="d-sm-flex justify-content-sm-between align-items-center">
                                            <div class="mt-3 mt-sm-0">
                                                <a href="../SingolaRichiestaServlet?idTutorato=<%=tutorato.getId()%>"
                                                   class="btn btn-outline-info">Seleziona</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-7">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-0 ms-2">
                                            <h6><p class="card-description">
                                                <br><code>&lt;<%=supporto.getStudenteEmail()%>&gt;</code>
                                            </p></h6>
                                        </div>
                                        ...
                                        <ul class="list-inline">
                                            <li class="list-inline-item h6 fw-light mb-1 mb-sm-0">
                                                ...
                                                <%=supporto.getOra().toUpperCase(java.util.Locale.ROOT)%>
                                            </li>
                                            <li class="list-inline-item h6 fw-light mb-1 mb-sm-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                     fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
                                                ...
                                                <%=supporto.getDipartimento().toUpperCase(java.util.Locale.ROOT)%>
                                            </li>
                                            <li class="list-inline-item h6 fw-light">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                     fill="currentColor" class="bi bi-journal-bookmark"
                                                ...
                                                <%=supporto.getInsegnamento().toUpperCase(java.util.Locale.ROOT)%>
                                            </li>
                                            <li class="list-inline-item h6 fw-light mb-1 mb-sm-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                ...
                                                <%=supporto.getModalitaEsame().toUpperCase(java.util.Locale.ROOT)%>
                                            </li>
                                        </ul>
                                        <div class="d-sm-flex justify-content-sm-between align-items-center">
                                            <div class="mt-3 mt-sm-0">
                                                <a href="../SingolaRichiestaServlet?idSupporto=<%=supporto.getId()%>"
                                                   class="btn btn-outline-info">Seleziona</a>
                                            </div>
                                        </div>
                                    </div>

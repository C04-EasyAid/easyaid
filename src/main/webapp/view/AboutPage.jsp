            ...
            <div class="row g-0 g-lg-5">
                        ...
                        <div class="col-md-6 col-lg-12">
                            <div class="card card-body shadow p-4 mb-4">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <div class="ms-3">
                                        <h5 class="mb-0">Stakeholder</h5><br>
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <div class="ms-3">
                                        <h6 class="mb-0">Software Engineer</h6><br>
                                        ...
                                        <h6 class="mb-0">Top Manager</h6><br>
                                        <h4 class="mb-3">Professoressa Filomena Ferrucci</h4>
                                    </div>
                                </div>
                ...
                <div class="col-lg-8">
                    ...
                    <p class="mt-4 fw-8">Il progetto «EasyAid» è nato con l’obiettivo di fornire servizi agli studenti con disabilità e DSA forniti dall’Ufficio Diritto allo Studio.
                        ...
                        Questa Web Application è stata creata durante gli esami di Gestione dei Progetti Software e Ingegneria del Software per l'Università degli Studi di Salerno.
                    </p> <br><br>

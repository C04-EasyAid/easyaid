...
public interface ITutoratoDidatticoDAO {
    ...
    TutoratoDidatticoBean doRetriveById(int id)
            throws SQLException, ClassNotFoundException;

    boolean InserimentoTutoratoDidattico(TutoratoDidatticoBean Bean) throws SQLException;

    boolean accettaRichiesta(int idSupporto, String emailTutor, String commento)
            throws SQLException;

    boolean approvaRichiesta(int idTutorato, String emailProf)
            throws SQLException;

    boolean completaRichiesta(int idTutorato, String emailTutor)
            throws SQLException;
}

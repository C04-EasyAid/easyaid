...
public interface IUserDAO {
    ...
    UserBean doRetrieveUtente(UserBean b)
    ...
    boolean insertStudente(StudenteBean s, UserBean b)
            throws SQLException, ClassNotFoundException;
